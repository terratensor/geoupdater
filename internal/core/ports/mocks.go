...
// MockRepository заглушка для тестов
type MockRepository struct {
	GetDocumentFunc       func(ctx context.Context, id string) (*domain.Document, error)
	GetDocumentsBatchFunc func(ctx context.Context, ids []string) (map[string]*domain.Document, error)
...
func (m *MockRepository) GetDocument(ctx context.Context, id string) (*domain.Document, error) {
...
func (m *MockRepository) GetDocumentsBatch(ctx context.Context, ids []string) (map[string]*domain.Document, error) {
